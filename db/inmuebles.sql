...
INSERT INTO `caracteristicas` (`id`, `nombre`, `piso`, `habitacion`) VALUES
(1, 'Piso mixto', 0, 1),
(2, 'Ascensor', 1, 1),
(3, 'Banio', 0, 1),
(4, 'Piscina', 1, 1),
...
INSERT INTO `caracteristicas_inmueble` (`caracteristica_id`, `inmuble_id`, `value`) VALUES
(2, 56, 0),
(4, 56, 1),
(5, 56, 0),
(6, 56, 1);
...
(2, 'Pablo', 'Martin lopez', '676688670', 'martinlopezpablo@gmail.com', '2023-11-02 18:23:26', 1, 'asd', 'adf'),
(3, 'Pablo', 'Martin lopez', '676688670', 'martinlopezpablo@gmail.com', '2023-10-30 10:22:27', 0, 'sdg', 'sdfhg'),
(4, 'Pablo', 'Martin lopez', '616100285', 'asd@email.com', '2023-11-03 10:29:47', 0, 'sef', 'dhmWER'),
(5, 'Pablo', 'Martin lopez', '616100285', 'asd@email.com', '2023-11-03 10:30:42', 0, 'sef', 'dhmWER'),
(6, 'Pablo', 'Martin lopez', '616100285', 'asd@email.com', '2023-11-03 10:31:03', 0, 'sef', 'dhmWER'),
(7, 'pablo', 'Martin lopez', '', 'asd@email.com', '2023-11-03 10:31:15', 0, 'af', 'asd'),
(8, 'pablo', 'Martin lopez', '', 'asd@email.com', '2023-11-03 10:31:32', 0, 'af', 'asd'),
(9, 'pablo', 'Martin lopez', '', 'asd@email.com', '2023-11-03 10:31:46', 0, 'dsf', 'sfh'),
(10, 'pablo', 'Martin lopez', '', 'asd@email.com', '2023-11-03 10:32:08', 0, 'asr', 'dfg'),
(11, 'pablo', 'Martin lopez', '', 'asd@email.com', '2023-11-03 10:33:52', 0, 'asr', 'dfg'),
(12, 'pablo', 'Martin lopez', '', 'asd@email.com', '2023-11-03 10:34:11', 0, 'asr', 'dfg'),
(13, 'pablo', 'Martin lopez', '', 'asd@email.com', '2023-11-03 10:34:20', 0, 'asr', 'dfg');
...
INSERT INTO `inmuebles` (`id`, `nombre`, `imagen`, `text`, `precio`, `disponible`, `localizacion_id`) VALUES
(56, 'test1', 'default.png', '', 0, 1, 0);
...
INSERT INTO `newclient` (`id`, `nombre`, `apellido`, `tel`, `email`, `fecha`, `Abierto`, `asunto`, `text`, `visible`) VALUES
(1, 'pablo', 'martin', '', '', '2023-11-02 18:23:02', 1, '', '', 0);
...
(1, 'admin', 'c7ad44cbad762a5da0a452f9e854fdc1e0e7a52a38015f23f3eab1d80b931dd472634dfac71cd34ebc35d16ab7fb8a90c81f975113d6c7538dc69dd8de9077ec', 1, '2023-11-03 23:00:00'),
...
(3, 'Habbo', 'fedcf30c0121e25e7e55e4a9328069829550b11db10ea86b26dae51c00e4d2a3c774e2e9ab9b3a5b2272eb8be9823744eedb9e9532bc1a90c974e7a4e8f4979c', 1, '2023-10-30 23:00:00');
...
ALTER TABLE `caracteristicas_inmueble`
  ADD UNIQUE KEY `caracteristica_id` (`caracteristica_id`,`inmuble_id`);
